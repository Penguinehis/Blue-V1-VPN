	...
	implements DialogInterface.OnCancelListener
{
	...
	private void askForPW(final int type) {
        ...
        dialog.setTitle("Você não digitou um usuário e senha!");
        ...
        dialog.setNegativeButton("OK,VOLTAR",
	...
	private void noInternet(final int type) {
		AlertDialog.Builder dialog = new AlertDialog.Builder(this);
		dialog.setTitle("Parece que não tem sinal de rede...");
		dialog.setMessage("Veja se ativou os dados móveis,e se tem sinal de rede no local");
		dialog.setOnCancelListener(this);
